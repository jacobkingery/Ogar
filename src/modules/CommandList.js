...
Commands.list = {
    help: function(gameServer, split) {
        ...
        console.log("[Console] addbotpythonmulti [number] [respawn]  : add a python bot to the server, each bot spawns its own python process");
        console.log("[Console] addbotpythonsingle [number] [port] [respawn]: add a python bot to the server, all bots use one python process (must be instansiated seperately)");
    ...
    addbotpythonmulti: function(gameServer, split) {
        ...
        for (var i = 0; i < add; i++) {
            gameServer.botsPython.addBotMulti(respawn);
        }
    ...
    addbotpythonsingle: function(gameServer, split) {
        ...
        for (var i = 0; i < add; i++) {
            gameServer.botsPython.addBotSingle(port, respawn);
        }
        console.log("[Console] Added " + add + " python player bots");
    },
